...
import cn.redture.aiEngine.model.util.ModelToolRegistry;
...
public class DashscopeModelProviderStrategy implements ModelProviderStrategy {
    ...
    private final ModelToolRegistry modelToolRegistry;
    ...
    public String callWithTools(String prompt, String modelName) {
        ...
        for (int round = 0; round < 3; round++) {
            ...
            for (JsonNode toolCall : toolCallsNode) {
                ...
                String toolResult = modelToolRegistry.executeTool(toolName, arguments);
    ...
    private String buildToolPayload(String modelName, List<Map<String, Object>> messages) {
        ...
        payload.put("tools", modelToolRegistry.listToolDefinitions());
